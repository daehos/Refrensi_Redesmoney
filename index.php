...
$jumlahmasuk = isset($arraymasuk) ? array_sum($arraymasuk) : 0;;
...
$jumlahkeluar = isset($jumlahkeluar) ? array_sum($jumlahkeluar) : 0;
...
$query = "SELECT jumlah, DAYOFWEEK(tgl_pemasukan) AS day_of_week FROM pemasukan";
